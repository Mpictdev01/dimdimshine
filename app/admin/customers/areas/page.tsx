  ...
  return (
    <div className="p-8 h-full relative flex flex-col">
      <div className="flex justify-between items-center mb-8 shrink-0">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Area / Rute Pelanggan</h1>
          <p className="text-slate-500">Kelompokkan toko pelanggan berdasarkan wilayah untuk mempermudah Sales.</p>
        </div>
        <button 
          onClick={() => openModal()}
